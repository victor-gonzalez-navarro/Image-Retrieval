function algo3MADmej(IR, IG, IB, bins)
...
for j=1:numimagesinputtxt
        ...
        for i=1:2000
            MADR = algo2versio1(IR(i,:), hr,bins);
            MADG = algo2versio1(IG(i,:), hg,bins);            
            MADB = algo2versio1(IB(i,:), hb,bins);            
            M1 = MADR + MADG + MADB;
            distance1(i) = M1;
            
            MADR = algo2versio2(IR(i,:), hr,bins);
            MADG = algo2versio2(IG(i,:), hg,bins);            
            MADB = algo2versio2(IB(i,:), hb,bins);            
            M2 = MADR + MADG + MADB;
            distance2(i) = M2;
            
            MADR = algo2versio3(IR(i,:), hr,bins);
            MADG = algo2versio3(IG(i,:), hg,bins);            
            MADB = algo2versio3(IB(i,:), hb,bins);            
            M3 = MADR + MADG + MADB;
            distance3(i) = M3;
            
            MADR = algo2versio4(IR(i,:), hr,bins);
            MADG = algo2versio4(IG(i,:), hg,bins);            
            MADB = algo2versio4(IB(i,:), hb,bins);            
            M4 = MADR + MADG + MADB;
            distance4(i) = M4;
        end
